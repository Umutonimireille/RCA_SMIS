<li ><a class="idTabs" href="#admin"><img
	...
	<ul class="noJS" style="height: 80px">
...
<li><a
	...
	<ul class="noJS"style="height: 40px">
		<li><a
...
<li><a class="idTabs" href="#students"><img
	...
	<ul class="noJS" style="height: 90px">
		<li><a
...
<li><a class="idTabs" href="#reports"><img
	...
	<ul class="noJS" style="height: 140px">
		<li><a
		...
		<li><a
			href="studentReportPdf.php?page=studentpdf"><img
