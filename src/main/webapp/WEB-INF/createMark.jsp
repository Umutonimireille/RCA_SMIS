...
<div class="container">
    ...
    <form  action="createmark.php?page=createmark" method="post">
        <input type="text" placeholder="Student's courseName" required name="courseName">
        <input type="text" placeholder="Student's instructorName" required name="instructorName">
        <input type="number" placeholder="averageMarks" required name="averageMarks">
